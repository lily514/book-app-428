...
public class BookCardListAdapterDetailed extends RecyclerView.Adapter<BookCardListAdapterDetailed.CardViewHolder> {
    private List<Book> book_ids;
    private ViewGroup parent;
    private OnBitmapComplete listener;

    public BookCardListAdapterDetailed(List<Book> recommendedBooks, OnBitmapComplete fragmentParent) {
    ...
    public CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View bookCardView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_layout_wide, parent, false);
