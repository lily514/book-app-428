...
import com.cs428.app.bookapp.adapter.NavDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void setUp(int fragmentId, DrawerLayout layout, final Toolbar toolbar) {
        ...
        drawerLayout = layout;
        drawerToggle = new ActionBarDrawerToggle(getActivity(), layout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            @Override
